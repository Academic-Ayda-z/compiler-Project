...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_IDENTFIRE = 4,                  /* IDENTFIRE  */
  YYSYMBOL_5_ = 5,                         /* '='  */
  YYSYMBOL_6_ = 6,                         /* '-'  */
  YYSYMBOL_7_ = 7,                         /* '+'  */
  YYSYMBOL_8_ = 8,                         /* '*'  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "IDENTFIRE",
  "'='", "'-'", "'+'", "'*'", "'/'", "UMINUS", "'('", "')'", "$accept",
...
{
       5,     6,    12,    13,     1,    11,    19,    20,     7,     0,
      17,    18,    14,    15,     3,     4,     0,    16
};

static const yytype_int8 yycheck[] =
{
       3,     4,     6,     7,     4,     7,    14,    15,    11,    -1,
      12,    13,     8,     9,     5,     0,    -1,    12
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* assignment: IDENTFIRE '=' expr  */
#line 44 "parser.y"
                                    {printf("%s = %s ;\n",(yyvsp[-2].id),(yyvsp[0].nonTerminal));}
#line 1093 "parser.tab.c"
    break;

  case 3: /* expr: term '+' expr  */
#line 48 "parser.y"
                              {tostring(string,indexT);strcpy(t,"t");strcat(t,string);strcpy((yyval.nonTerminal),t);
                                    if(lastT)printResult((yyvsp[0].nonTerminal),'+',(yyvsp[-2].nonTerminal));
                                    else {constructLastT((yyvsp[0].nonTerminal),"+",(yyvsp[-2].nonTerminal));strcpy((yyval.nonTerminal),lastTvalue);} }
#line 1101 "parser.tab.c"
    break;

  case 4: /* expr: term '-' expr  */
#line 52 "parser.y"
                              {tostring(string,indexT);strcpy(t,"t");strcat(t,string);strcpy((yyval.nonTerminal),t);                        
                                    if(lastT)printResult((yyvsp[0].nonTerminal),'-',(yyvsp[-2].nonTerminal));
                                    else {constructLastT((yyvsp[0].nonTerminal),"-",(yyvsp[-2].nonTerminal));strcpy((yyval.nonTerminal),lastTvalue);} }
...
#line 59 "parser.y"
                              {tostring(string,indexT);strcpy(t,"t");strcat(t,string);printf("t%d = %s * %s;\n", indexT++, (yyvsp[0].nonTerminal), (yyvsp[-2].nonTerminal));strcpy((yyval.nonTerminal),t);}
#line 1121 "parser.tab.c"
    break;

  case 7: /* term: factor '/' term  */
#line 60 "parser.y"
                              {tostring(string,indexT);strcpy(t,"t");strcat(t,string);printf("t%d = %s / %s;\n", indexT++, (yyvsp[0].nonTerminal), (yyvsp[-2].nonTerminal));strcpy((yyval.nonTerminal),t);}
